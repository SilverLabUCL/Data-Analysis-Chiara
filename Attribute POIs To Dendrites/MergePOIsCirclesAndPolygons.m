function [ PointsInSegments, POIsIn2Segm, POIsInNoSegm, SegmentsPerPOI ] = MergePOIsCirclesAndPolygons( PointsInSegmentsC, PointsInSegmentsP, n_segments, PointPlane )
