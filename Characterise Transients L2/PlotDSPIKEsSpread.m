function PlotDSPIKEsSpread( nStacks, FlagSave, ScalingFactorInfo, FilesLoaded, TreeLoaded )
...
if FlagSave
    ...
    saveas(gcf, 'DSPIKESpread Vs IntegralDSPIKE.fig')
    saveas(gcf-1, 'DSPIKESpread Vs AmplitudeDSPIKE.fig')
    saveas(gcf-2, 'DSPIKESpread DistanceBranches.fig')
    saveas(gcf-3, 'DSPIKESpread OrderBranches.fig')
end
