function [ OrientationCurveIntegral, DataPerOrient ] = OrTuningTuft2( AllStacksConcat, TimeAllStacks, FlagNorm, FlagSave)
...
StimulusOn = 2; %time when visual stimulus goes on in seconds
...
for Or = 1 : NumberOrientations
    ...
    colorbar;
    hold on;
    plot( repmat(StimulusOn*1e3/TimeRes, NumberRepetitions+2 ), 0:(NumberRepetitions+1), 'k-','LineWidth',2)
    hold all;
