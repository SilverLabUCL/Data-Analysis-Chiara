function [ SpatialDistribStatAll, SpatialDistribRunAll, SpatialDistribStat , SpatialDistribRun ] = SpatialDistribRunStat(nStacks, FlagSave, FilesLoaded)
...
for s = 1:nStacks
    ...
    [SumResponses, Start, End] = SumResponsesFunction(ResponsesBin); % computes vector with summation of responses, and indexes of beginning and end of each response 
